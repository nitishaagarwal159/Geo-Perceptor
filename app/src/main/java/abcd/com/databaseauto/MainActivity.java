    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      don.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                GeoServiceBuilder.build().getAllLists(p,"Your API here").enqueue(new ResponseCallback<LangLongResponse>() {
        ...
        e.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                GooglePlayServiceBuilder.build().getAllPlaces(msg,"Your API here").enqueue(new ResponseCallback<AllPlacesResponse>() {
                    @Override
